...
&lt;script type="text/javascript" src="<?php echo PJ_INSTALL_FOLDER; ?>index.php?controller=pjFront&amp;action=pjActionLoad&amp;layout={LAYOUT}&amp;view={VIEW}&amp;icons={ICONS}&amp;cats={CATS}"&gt;&lt;/script&gt;</div>
