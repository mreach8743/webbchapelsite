...
class pjAdmin extends pjAppController
{
	...
	public function pjActionIndex()
	{
		...
		if ($this->isAdmin() || $this->isEditor())
		{
			...
			$today_events = $pjEventModel->where('event_date', date('Y-m-d'))->orderBy('t1.start_time ASC')->findAll()->getData();
			
			$cnt_events =  $pjEventModel->reset()->findCount()->getData();
			$cnt_users =  $pjUserModel->findCount()->getData();
			
			$upcoming_events = $pjEventModel->reset()->where("t1.event_date > '" . date('Y-m-d' . "'"))->orderBy('t1.event_date ASC, t1.start_time ASC')->limit(5, 0)->findAll()->getData();
