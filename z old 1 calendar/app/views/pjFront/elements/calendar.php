							...
							if($run_day_timestamp < $first_day_timestamp)
							{
								...
								if($run_day_timestamp <= $last_day_timestamp)
								{
									...
									if(!empty($event_date_arr[$run_date]))
									{
										...
										?>
										<td class="pjTooltipster pjIcDayChosen pjPecDayHasEvents" data-day="<?php echo $day; ?>" data-events="<?php echo $num_events;?>" title="<?php echo join("&lt;/p&gt; &lt;p&gt;", $event_array);?>"><?php echo $day;;?></td>
										<?php
									}else{
										if($run_day_timestamp == $today_timestamp)
										{
											?><td class="pjTooltipster pjIcDayToday" title="<?php __('front_today');?>"><?php echo $day;?></td><?php
										}else{
