	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionLogin" method="post" id="frmLoginAdmin" class="form">
		...
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input type="text" name="login_email" id="login_email" class="pj-form-field required email w250" data-msg-required="<?php __('lblFieldRequired');?>" data-msg-email="<?php __('lblEmailInvalid');?>"/>
			</span>
		</p>
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input type="password" name="login_password" id="login_password" class="pj-form-field required w250" autocomplete="off" data-msg-required="<?php __('lblFieldRequired');?>"/>
			</span>
		</p>
		<p>
