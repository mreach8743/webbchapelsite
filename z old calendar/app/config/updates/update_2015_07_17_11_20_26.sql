...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '1', 'title', 'Days of the next month', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '2', 'title', 'Days of the next month', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '3', 'title', 'Days of the next month', 'script');
...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '1', 'title', 'Days of the previous month', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '2', 'title', 'Days of the previous month', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '3', 'title', 'Days of the previous month', 'script');
