...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '1', 'title', 'starts at', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '2', 'title', 'starts at', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '3', 'title', 'starts at', 'script');

INSERT INTO `fields` VALUES (NULL, 'front_ends_at', 'frontend', 'Label / ends at', 'script', '2015-07-20 03:09:01');

SET @id := (SELECT LAST_INSERT_ID());

INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '1', 'title', 'ends at', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '2', 'title', 'ends at', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '3', 'title', 'ends at', 'script');

INSERT INTO `fields` VALUES (NULL, 'front_no_events_found', 'frontend', 'No events found.', 'script', '2015-07-20 03:30:32');

SET @id := (SELECT LAST_INSERT_ID());

INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '1', 'title', 'No events found.', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '2', 'title', 'No events found.', 'script');
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '3', 'title', 'No events found.', 'script');
