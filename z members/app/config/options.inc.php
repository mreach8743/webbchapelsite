...
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "46");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "3.0.0");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "memberlogin_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjBackup', 'pjLog', 'pjInstaller', 'pjOneAdmin',  'pjPaypal', 'pjPaypalSubscr');
?>