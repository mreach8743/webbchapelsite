...
<html>
	<head>
		<title>Member Login Script by PHPJabbers.com</title>
	...
	<body>
		<div id="container">
    		<div id="header">
				<a href="http://www.phpjabbers.com/member-login/" id="logo" target="_blank"><img src="<?php echo PJ_INSTALL_URL . PJ_IMG_PATH; ?>backend/logo.png" alt="" /></a>
			</div>
