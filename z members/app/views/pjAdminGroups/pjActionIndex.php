...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminGroups&amp;action=pjActionIndex"><?php __('menuGroups'); ?></a></li>
	...
	<?php
	pjUtil::printNotice(__('infoGroupListTitle', true), __('infoGroupListBody', true)); 
	?>
	<div class="b10">
	...
	<script type="text/javascript">
		...
		myLabel.registration_fee = "<?php __('lblRegistrationFee'); ?>";
		myLabel.subscription_fee = "<?php __('lblSubscriptionFee'); ?>";
		myLabel.members = "<?php __('lblMembers'); ?>";
