...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminFiles&amp;action=pjActionIndex"><?php __('lblUploadedFiles'); ?></a></li>
	...
	<?php
	pjUtil::printNotice(__('infoFileListTitle', true), __('infoFileListBody', true)); 
	?>
	<div class="b10">
	...
	<script type="text/javascript">
		...
		myLabel.uploaded = "<?php __('lblUploadedDateTime'); ?>";
		...
		myLabel.same_title = "<?php __('pj_same_title'); ?>";
	</script>
	<?php
}
?>